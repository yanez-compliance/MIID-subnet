...
# generate node keys
$BASE_DIR/target/production/node-subtensor key generate-node-key --chain="$FULL_PATH" --base-path /tmp/alice
$BASE_DIR/target/production/node-subtensor key generate-node-key --chain="$FULL_PATH" --base-path /tmp/bob
