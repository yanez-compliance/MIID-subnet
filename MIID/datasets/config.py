...
ALLOWED_HOTKEYS: List[str] = [
    ...
    "5Dvgtk1bqLycAyyc2VFKvAqmpvoQf5oWsD4qnu6vqbdWSL54", #RT21 new HK
    ...
    "5GMqiKcdq5WtHA4XaioRD29FL2UtJ8CW1MVQtYHyFsqzrrmM", # new validator
]
...
TIER_BOUNDARIES = {
    "Black":    (250.001, 9999.0),  # rep_score > 250.0
    "Platinum": (150.0, 250.0),     # rep_score 150.0 - 250.0
    "Diamond":  (50.0, 149.999),    # rep_score 50.0 - 149.999
