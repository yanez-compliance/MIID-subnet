...
from MIID.miner.generate_possible_count_pairs_v8 import generate_all_possible_count_pairs_v8
...
from MIID.validator.reward_v8 import get_name_variation_rewards
...
def generate_name_variations(
    ...
    #     len(effective_rules)
    # )
    rule_count_pairs = generate_all_possible_count_pairs_v8(
        expected_total_count,
