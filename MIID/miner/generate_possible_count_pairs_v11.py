...
def generate_all_possible_count_pairs_v11(expected_count, minimum_rule_based_count, rule_percent, phonetic_similarity) -> list[Tuple[int, int]]:
    ...
    min_required = max(1, int(expected_count * 0.8)) 
    ...
    for base_count, level, counts, rank in ordered_list:
        ...
        for rule_based_count in range(0, int(expected_count * 1.2) + 1):
            ...
            if _minimum_rule_based_count + additional_rule_based_count + duplicated_rule_based_count + base_count < min_required:
                base_count = min_required - _minimum_rule_based_count - additional_rule_based_count - duplicated_rule_based_count
